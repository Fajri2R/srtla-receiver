...
';
  ...
  themeCss.textContent = [
    ...
    '@media (max-width: 480px) { .navbar, nav, header { padding-left: 12px !important; padding-right: 12px !important; } .navbar-brand, .navbar .navbar-brand { font-size: 13px !important; } .hls-manager-nav-btn { flex-basis: 34px !important; width: 34px !important; min-width: 34px !important; height: 34px !important; } button[title="Settings"] { height: 34px !important; padding: 0 10px !important; font-size: 12px !important; } }'
  ].join('\n');
